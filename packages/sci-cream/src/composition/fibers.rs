...
///
/// See the [fibers documentation](crate::docs#fibers) for more information on the different types
/// of fibers, their physical and sensory properties, and their effects in ice cream formulations.
#[derive(Iterable, PartialEq, Serialize, Deserialize, Copy, Clone, Debug)]
#[serde(default, deny_unknown_fields)]
pub struct Fibers {
    /// Inulin is a type of soluble fiber found in many plants, with useful functional properties
    ///
    /// See the [inulin documentation](crate::docs#inulin) for more information.
    pub inulin: f64,
    /// Oligofructose is a type of soluble fiber that is chemically similar to inulin, but with a
    /// shorter chain length
    ///
    /// See the [oligofructose documentation](crate::docs#oligofructose) for more information.
