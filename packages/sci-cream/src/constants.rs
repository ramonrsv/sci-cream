...
pub const PAC_FPD_TABLE_STEP: usize = 3;
pub const PAC_FPD_TABLE_MAX_PAC: usize = 180;
pub const PAC_FPD_TABLE: [(usize, f64); 61] = [
    (0, 0.0),
    (3, 0.18),
    (6, 0.35),
    (9, 0.53),
...
// pub const FPD_POLYNOMIAL_FACTORS: [f64; 3] = [-0.1617229483, 0.0647948043, 0.0000785525]; // not inc. 184.83: 14.27
pub const FPD_POLYNOMIAL_FACTORS: [f64; 3] = [-0.1720419078, 0.0652588455, 0.000075372]; // including 184.83: 14.27
