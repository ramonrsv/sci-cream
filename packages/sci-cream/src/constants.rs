...
pub mod stabilization {
    ...
    /// @todo...
    pub const STABILIZER_STRENGTH_EGG_YOLK_PROTEINS: f64 = 1.0;
...
///
/// Lecithin is the reference emulsifier, so its value is set to 100. Ice cream formulations
/// have a recommended dosage of ~3.25g/kg (Raphaelson, 2016, Standard Base)[^5]. This is used
/// as a reference when estimating the relative strength of other emulsifiers, i.e. by comparing
