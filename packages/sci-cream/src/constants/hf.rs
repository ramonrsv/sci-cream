...
//! hardness of mixes containing chocolate and nut ingredients (Corvitto, 2005, p. 243, 274)[^3].
...
///
/// (Corvitto, 2005, p. 243)[^3]
#[doc = include_str!("../../docs/references/index/3.md")]
pub const COCOA_BUTTER: f64 = 0.9;
