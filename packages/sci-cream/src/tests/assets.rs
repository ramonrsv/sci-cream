...
pub(crate) static MAIN_RECIPE_PROPERTIES: LazyLock<Vec<(PropKey, f64)>> = LazyLock::new(|| {
    ...
    vec![
        ...
        (StabilizersPerWater.into(), 0.3459),
        (POD.into(), 15.234),
        (PACsgr.into(), 27.614),
        (PACmlk.into(), 3.247),
        (PACalc.into(), 2.107),
...
pub(crate) static REF_A_RECIPE_PROPERTIES: LazyLock<Vec<(PropKey, f64)>> = LazyLock::new(|| {
    ...
    vec![
        ...
        (Water.into(), 60.150),
        (TotalEmulsifiers.into(), 0.5555),
        (EmulsifiersPerFat.into(), 3.3225),
        (TotalStabilizers.into(), 0.1392),
        (StabilizersPerWater.into(), 0.2315),
        (POD.into(), 11.545),
        (PACsgr.into(), 21.02),
        (PACmlk.into(), 4.103),
        (PACalc.into(), 0.0),
...
pub(crate) static REF_B_RECIPE_PROPERTIES: LazyLock<Vec<(PropKey, f64)>> = LazyLock::new(|| {
    ...
    vec![
        ...
        (Water.into(), 63.158),
        (TotalEmulsifiers.into(), 0.5566),
        (EmulsifiersPerFat.into(), 3.442),
        (TotalStabilizers.into(), 0.1495),
        (StabilizersPerWater.into(), 0.2366),
        (POD.into(), 10.336),
        (PACsgr.into(), 12.419),
        (PACmlk.into(), 4.075),
        (PACalc.into(), 21.778),
