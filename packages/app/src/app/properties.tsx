...
export const DEFAULT_SELECTED_PROPERTIES: Set<PropKey> = new Set([
  ...
  compToPropKey(CompKey.CacaoFat),
  compToPropKey(CompKey.NutFat),
  compToPropKey(CompKey.OtherFat),
  compToPropKey(CompKey.TotalFat),
  compToPropKey(CompKey.MSNF),
  compToPropKey(CompKey.EggSNF),
  compToPropKey(CompKey.CocoaSNF),
  ...
  compToPropKey(CompKey.Sugars),
  compToPropKey(CompKey.ArtificialSweeteners),
