...
Namely, this repo contains the `sci-cream` Rust crate, a library to facilitate the mathematical
analysis of ice cream mixes and their properties, as well as the `sci-cream` App, a Next.js app that
provides user-friendly utilities to facilitate the development and study of ice cream recipes. There
is also [documentation](https://docs.rs/sci-cream/latest/sci_cream/docs/index.html) about ice cream
science, and an [ingredient
...
[![GitHub Release](https://img.shields.io/github/v/release/ramonrsv/sci-cream?filter=sci-cream-v*)](https://github.com/ramonrsv/sci-cream/releases/tag/sci-cream-v0.0.6)
...
[![GitHub Release](https://img.shields.io/github/v/release/ramonrsv/sci-cream?filter=app-v*)](https://github.com/ramonrsv/sci-cream/releases/tag/app-v0.0.4)
...
app that utilizes the `sci-cream` crate to provide user-friendly utilities, most notably an ice
cream calculator, to facilitate the development and study of ice cream recipes.
